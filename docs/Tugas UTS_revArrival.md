...
### 1.1 Project Context
PT Bahtera Adhiguna, sebagai anak perusahaan PLN, membutuhkan sistem monitoring prediktif arrival untuk armada kapal pengangkut batubara mereka.

### 1.2 Problem Statement
- **Ketidakpastian waktu kedatangan** kapal yang mempengaruhi perencanaan logistik

### 1.3 Objectives
**Predictive Analysis:** Machine learning model untuk prediksi vessel arrival time
...
### 2.2 System Architecture Diagram <<<ini mager ngeditnya wkkw>>>
...
- **Automated Reports:** Daily/weekly/monthly trip summary
...
- **Predictive Insights:** Recommendations for router optimization <<ini nyari masalah sih ya wkkw hapus aja boleh>>
...
- **IEC 61162:** Maritime navigation and radiocommunication equipment and systems <<untuk apa ya ini?>>
...
**Data Quality Rules:**
1. **Consistency:** Speed not exceeding vessel max speed (25 knots)
2. **Timeliness:** Data timestamp within last 10 minutes
3. **Accuracy:** GPS coordinates within Indonesian waters
